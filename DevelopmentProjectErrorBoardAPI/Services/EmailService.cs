namespace DevelopmentProjectErrorBoardAPI.Services
{
    ...
    public class EmailService : IEmailService
    {
        ...
        public StringBuilder BuildEmail(User user, User dev, int? customerId, int status)
        {
            ...
            template.AppendLine();
            template.AppendLine($"Thank you for your patience. The problem you faced while handling " +
                                $"the account of the customer with the account Id {customerId} has been updated to status" +
